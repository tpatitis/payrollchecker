...
# --- ΣΤΑΔΙΟ 3: ΜΙΣΘΟΔΟΣΙΑ ΥΠΑΛΛΗΛΩΝ ---
    ...
    class PayrollFinancials(pydantic.BaseModel):
        ...
        Σύνολο_Αποδ: float = pydantic.Field(description="Οι συνολικές μικτές αποδοχές του υπαλλήλου (το άθροισμα Τακτικών, Δώρων και Επιδομάτων) ή αλλιώς το συνολικό κόστος. Συνήθως είναι το συνολικό κόστος στο τελος των δεδομενων")
