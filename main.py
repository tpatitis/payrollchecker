...
class PayrollFinancials(BaseModel):
    ...
    Σύνολο_Εισφ: float = Field(
        description="Το σύνολο όλων των ασφαλιστικών εισφορών."
    )

    ΦΜΥ: float = Field(
        description="Ο Φόρος Μισθωτών Υπηρεσιών."
    )
    ...
    Δώρο_Πάσχα: float = Field(
        description="Ποσό Δώρου Πάσχα."
    )

    Δώρο_Χριστουγέννων: float = Field(
        description="Ποσό Δώρου Χριστουγέννων."
    )

    Επίδομα_Άδειας: float = Field(
        description="Ποσό Επιδόματος Άδειας."
    )
    ...
    Σύνολο_Αποδ: float = Field(
        description="Συνολικές μικτές αποδοχές."
    )
